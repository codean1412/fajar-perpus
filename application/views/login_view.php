...
<head>
  ...
  <!-- Bootstrap 3.3.7 -->
  <link rel="shortcut icon" href="<?php echo base_url('assets_style/image/logo.png') ?>" />
...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/22.jpg');?>')no-repeat;background-size:100%;">
<div class="login-box">
  <div class="login-logo">
    <a href="index.php" style="color: white;">Sistem Informasi Perpustakaan<br/><b>SMA Negeri 1 Wangon</b></a>
  </div>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: white;"> Copyright &copy; SMA Negeri 1 Wangon - <?php echo date("Y");?><!-- 
			 <br><center><p>Repost by <a href='https://google.com/' title='StokCoding.com' target='_blank'>StokCoding.com</a></p></center> -->
