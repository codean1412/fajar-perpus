...
<footer class="main-footer">
    <div id="mycredit"><strong> Copyright &copy; <?php echo date('Y');?> Sistem Informasi Perpustakaan SMA Negeri 1 Wangon 
    </strong> All rights | Page rendered in <strong>{elapsed_time}</strong> seconds. | Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>SMA Negeri 1 Wangon</a>
